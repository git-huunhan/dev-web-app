...
class lab04 extends Component {
  ...
  render(){
    return(
      <div>
        <Container>
          <h2>Lab 4. Tải và cài đặt MySQL trên Docker</h2>
          <div>
            <Breadcrumb tag="nav" listTag="div">
              ...
              <BreadcrumbItem active tag="span">Lab 4</BreadcrumbItem>
            </Breadcrumb>
          </div>
          <Row>
