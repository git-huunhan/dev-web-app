...
class lab05 extends Component {
  ...
  render(){
    return(
      <div>
        <Container>
          <h2>Lab 6. Tải và cài đặt MongoDB trên Docker</h2>
          <div>
            <Breadcrumb tag="nav" listTag="div">
              ...
              <BreadcrumbItem active tag="span">Lab 6</BreadcrumbItem>
            </Breadcrumb>
          </div>
          <Row>
